# Generated by Powerlevel10k configuration wizard on 2021-12-12 at 22:05 EET.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      '*prod*'  PROD    # These values are examples that are unlikely
      '*ops*'   OPS     # to match your needs. Customize them as needed.
      '*f10*'   TEST
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_FOREGROUND=7
  typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_BACKGROUND=1
  typeset -g POWERLEVEL9K_KUBECONTEXT_OPS_FOREGROUND=0
  typeset -g POWERLEVEL9K_KUBECONTEXT_OPS_BACKGROUND=12
  typeset -g POWERLEVEL9K_KUBECONTEXT_TEST_FOREGROUND=0
